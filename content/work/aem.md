...
- Sole architect and engineer across the full AEM software portfolio — spanning native desktop (C++/C#), web (Meteor/Node.js), and developer tooling
...
- Built AQ-1 Data Logger PC software from scratch; solved high-speed USB data loss with Async IO Completion Ports, and replaced bloated .NET serialization with Protocol Buffers to meet hardware storage constraints
